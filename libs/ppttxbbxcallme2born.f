      subroutine ppttxbbxcallme2born (M2, ccP, Mt, Mh)
...
c      print *, "P(i,j) ", P(i,j)
     ...
     & leading_colour)
c      print *, "Param init"
      call set_permutation_ppttbb_ttxbbxgg_1([5, 6, 2, 1, 4, 3])
c      print *, "set_permut"
      call AMP2tree_ppttbb_ttxbbxgg_1(P, M2)
c      print *, "Amp2"
      end 
